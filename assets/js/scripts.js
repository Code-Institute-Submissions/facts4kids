...
$(document).ready(function () {
    ...
    $('#countries').change(function () {
        ...
        var info = [
            ...
            ["Antigua and Barbuda", "Each endeavouring, all achieving", "St. John's", "English", "97,929", "440", "East Caribbean dollar (XCD)", "UTC-4 (AST)", "assets/img/antigua-and-barbuda.png"],
            ...
            ["Burundi", "Unity, Work, Progress", "Bujumbura", "Kirundi", "11,890,784", "25,680", "Burundian franc (BIF)", "UTC+2 (CAT)", "assets/img/burundi.png"],
            ...
            ["Chad", "Unity, Work, Progress", "N'Djamena", "Arabic, French", "16,425,864", "1,259,200", "Central African CFA franc (XAF)", "UTC+1 (WAT)", "assets/img/chad.png"],
            ...
            ["Côte d'Ivoire", "Unity, Discipline, Labor", "Yamoussoukro, Abidjan", "French", "26,378,274", "318,000", "West African CFA franc (XOF)", "UTC (GMT)", "assets/img/cote-d-ivoire.png"],
            ...
            ["Grenada", "Ever conscious of God we aspire, and advance as one people", "St. George's", "English", "112,523", "340", "East Caribbean dollar (XCD)", "UTC−4", "assets/img/grenada.png"],
            ...
            ["Monaco", "With God's help", "Monaco-Ville", "French", "39,242", "1", "Euro (EUR)", "UTC+1 (CET)", "assets/img/monaco.png"],
            ...
            ["Nauru", "God's will first", "None", "Nauruan, English", "10,824", "20", "Australian dollar (AUD)", "UTC+12", "assets/img/nauru.png"],
            ...
            ["North Korea", "No official motto", "Pyongyang", "Korean", "25,778,816", "120,410", "Korean People's won (KPW)", "UTC+9 (Pyongyang Time)", "assets/img/north-korea.png"],
